...
def menu_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        [
            InlineKeyboardButton(text="▪️Точка поблизости", callback_data="nearest_point")
        ],
        [
            InlineKeyboardButton(text="▪️Мои комментарии", callback_data="my_comments")
        ],
        [
            InlineKeyboardButton(text="▪️Профиль", callback_data="profile")
        ]
    ])
